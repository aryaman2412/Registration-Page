...
if(status=="invalidName"){
	swal("Sorry","Please give a valid  name","success");
}
if(status=="invalidEmail"){
	swal("Sorry","Please give valid email","success");
}
if(status=="invalidUpwd"){
	swal("Sorry","Please give valid password","success");
}
if(status=="invalidNumber"){
	swal("Sorry","Please give valid mobile","success");
}
</script>
